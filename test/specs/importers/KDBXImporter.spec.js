...
const EXAMPLE_LEGACY = path.resolve(__dirname, "../../resources/test-archive-kdbx3.kdbx");
const EXAMPLE_LEGACY_ADVANCED = path.resolve(__dirname, "../../resources/test-archive-keyfile-kdbx3.kdbx");
const EXAMPLE_LEGACY_ADVANCED_KEY = path.resolve(__dirname, "../../resources/test-archive-keyfile-kdbx3.key");

const EXAMPLE_V4 = path.resolve(__dirname, "../../resources/test-archive-kdbx4.kdbx");
const EXAMPLE_V4_ADVANCED = path.resolve(__dirname, "../../resources/test-archive-keyfile-kdbx4.kdbx");
const EXAMPLE_V4_ADVANCED_KEY = path.resolve(__dirname, "../../resources/test-archive-keyfile-kdbx4.key");

describe("KDBXImporter", function() {
    describe("KDBX (pre-v4)", function() {
        beforeEach(function() {
            const simpleImporter = new KDBXImporter(EXAMPLE_LEGACY);
            const advancedImporter = new KDBXImporter(EXAMPLE_LEGACY_ADVANCED, EXAMPLE_LEGACY_ADVANCED_KEY);
            return Promise
                .all([
        ...
        it("exports expected groups", function() {
            ...
            const [generalGroup] = this.simpleVault.findGroupsByTitle("General");
    ...
    describe("KDBX v4", function() {
        beforeEach(function() {
            ...
            const advancedImporter = new KDBXImporter(EXAMPLE_V4_ADVANCED, EXAMPLE_V4_ADVANCED_KEY);
            return Promise
                .all([
                    simpleImporter.export(EXAMPLE_KDBX_PASSWORD),
                    advancedImporter.export(EXAMPLE_KDBX_PASSWORD)
